...
2. **Race & Class**: Large dramatic fantasy lettering reading exactly: **Elfen-Schurke** - gold text with subtle glow
3. **Subtitle**: Below the title in smaller elegant text: **Schattenläufer der Freiheit**
4. **Character portrait area**: A gold-framed circular or shield-shaped portrait of a sleek elf rogue in dark leather, dual daggers, hooded, moving through shadows. Heraldic, stylized, not photorealistic.
5. **Stats section**: Three stat values displayed in a clean fantasy UI bar. IMPORTANT: exactly ONE small icon per stat, no duplicates.
   - **Beweglichkeit: 20** (feather icon)
   - **Heimlichkeit: 19** (eye icon)
   - **Intelligenz: 15** (brain icon)
6. **NLP-Pfad section**: A distinct panel showing meta-programs:
   - **Struktur: Optional | Fokus: Weg-von | Maßstab: Internal**
7. **Magischer Filter**: A highlighted box or banner reading: **Umhang der Unsichtbarkeit**
8. **Description area**: Parchment-colored text panel reading exactly: **Regeln sind Fesseln für deinen Geist. Du findest immer einen kreativen Ausweg. Du willst Gefahr und Kontrolle vermeiden und vertraust nur deinem eigenen elfischen Instinkt.**
...
- **Border**: Ornate gold filigree border with **shadow, dagger, and crescent moon motifs** in the corners. Rogue-themed.
- **Color accent**: Dark green and silver for the elven shadow theme
